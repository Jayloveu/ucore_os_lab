...
alloc_proc(void) {
	 ...
	 */
     ...
     //LAB6 2015011403 : (update LAB5 steps)
    /*
    ...
    //LAB8:EXERCISE2 2015011403 HINT:need add some code to init fs in proc_struct, ...
        proc->filesp = NULL;
    }
    return proc;
}
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    ret = -E_NO_MEM;
    //LAB4:EXERCISE2 2015011403
    //LAB8:EXERCISE2 2015011403 HINT:how to copy the fs in parent's proc_struct?
    /*
